...
import ImageUploadPopUp from '../LandlordProfile/ImageUploadPopUp/ImageUploadPopUp'
import { BASE_URL } from '@/src/shared/utils/ky'
import LogOutModal from '../LandlordProfile/LogOutModal/LogOutModal'
            ...
            <div className='flex text-center flex-col items-center justify-center h-screen bottom-[100px] relative'>
                ...
                {/* <div className='mt-2 text-sm text-[#757575]'>
                    <h5>
                        ...
                        <a
                            href='/registration'
                            className='text-[#006BE6] hover:underline font-semibold'
                        >
                            Sign up here
                        </a>
                    </h5>
    ...
    return (
        <div className='text-white min-h-screen px-6 py-6 space-y-8'>
            ...
            {renderSection({
                ...
                icon: <SettingIcon />,
                keyName: 'settings',
                items: ['Notifications', 'Payment method'],
            })}
