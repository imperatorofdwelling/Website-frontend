...
export default function CancelledRemovePopup() {
    return (
        <Drawer>
            <DrawerTrigger asChild>
                <button className='border border-[#006BE6] px-6 py-2 w-full text-white rounded-lg default-hover-active bg-transparent'>
                    Remove
                </button>
            </DrawerTrigger>
            <DrawerContent>
                <div className='mx-auto w-full max-w-[480px]'>
                    <DrawerHeader>
                        <DrawerTitle className='text-center'>
                            Would you like to remove booking from list?
                        </DrawerTitle>
                    </DrawerHeader>
