...
export function ApartsDetailBookingPageUi() {
            ...
            <main className='flex flex-col gap-4'>
                ...
                <div>
                    ...
                    <div className='flex items-center justify-between bg-[#1F1F1F] p-4 mt-6'>
                        <div className='w-[50%]'>
                            <h3 className=' text-light_grey text-lg mb-2'>
                                Booking completed
                            </h3>
                        </div>
                        <button
                            onClick={() => router.push('/postreview')}
                            className='w-[200px] px-4 py-4 text-base font-semibold text-white border border-blue rounded-lg min-h-[56px] default-hover-active'
                        >
                            Write review
                        </button>
                    </div>
