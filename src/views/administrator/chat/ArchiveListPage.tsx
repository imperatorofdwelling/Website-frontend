...
import { ChatCard } from '@/src/shared/ui/administrator/chat/ChatCard'
import { chatData as initialChatData } from '@/src/shared/utils/chatMockData'
import { ChatOptionsModal } from '@/src/shared/ui/administrator/chat/ChatOptionsModal'
import { DeleteConfirmModal } from '@/src/shared/ui/administrator/chat/DeleteConfirmModal'
...
export function ArchiveListPageUi() {
    const router = useRouter()

    const [chatData, setChatData] = React.useState<Chat[]>(
        initialChatData.filter((chat) => chat.isArchived)
    )
                ...
                {sortedChats.length > 0 ? (
                    sortedChats.map((chat) => (
                        ...
                        >
                            <ChatCard
                                {...chat}
                                onClick={() => router.push('/administrator/chat/message')}
