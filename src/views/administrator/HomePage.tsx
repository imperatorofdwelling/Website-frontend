...
export function HomePageUi() {
  ...
  const stats = [
    { title: 'Total users', value: '180,780', percentage: '8.5%', subtitle: 'Compared to last month', trend: 'up' },
    { title: 'Total objects', value: '120,560', percentage: '8.5%', subtitle: 'Compared to last month', trend: 'up' },
    { title: 'Successful transactions', value: '68%', percentage: '8.5%', subtitle: 'Compared to last month', trend: 'up' },
    { title: 'Failed transactions', value: '32%', percentage: '8.5%', subtitle: 'Compared to last month', trend: 'down' },
  ]
...
const attendanceData = [
  ...
  const geographyRegions = [
    { name: 'Moskva', display: 'Moscow', value: 100780, color: '#1976d2', short: 'Mos' },
    { name: 'Sankt-Peterburg', display: 'St. Petersburg', value: 20000, color: '#42a5f5', short: 'St.P' },
    { name: 'Novosibirskaya oblast', display: 'Novosibirsk', value: 24000, color: '#e53935', short: 'Nvs' },
    { name: 'Krasnoyarskiy kray', display: 'Krasnoyarsk', value: 24000, color: '#43a047', short: 'Kys' },
    { name: 'Chelyabinskaya oblast', display: 'Chelyabinsk', value: 24000, color: '#2e7d32', short: 'Chb' },
    { name: 'Others', display: 'Others', value: 11998, color: '#fff', short: 'Oth' },
  ]
  
  const trafficSources = [
    { title: 'Social networks', percentage: 46, users: 80780, change: -1.2 },
