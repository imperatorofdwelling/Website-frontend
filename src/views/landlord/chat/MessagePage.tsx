...
export function MessagePageUi() {
    return (
        <div className='min-h-screen flex flex-col text-whitegap-4   pb-[100px] relative'>
            ...
            <div className='flex items-center gap-3 px-[16px] py-[24px] border-b border-[#222225]'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='flex items-center gap-1 mb-1'>
                        <LocationIcon />
                        <span className='text-xs text-[#757575]'>st. Star, 12</span>
                    </div>
                    <div className='flex items-center gap-1'>
                        <CalendarIcon />
                        <span className='text-xs text-[#757575]'>Apr 27 - May 3</span>
                    </div>
                </div>
                <ArrowRight />
            </div>
            ...
            <div className='w-full px-[16px] py-[8px] flex items-center gap-2 sticky bottom-0'>
                <div>
                    <PaperClip />
                </div>
                <input
