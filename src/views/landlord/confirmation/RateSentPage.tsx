...
import RateSent from '@/public/images/landlord/confirmation/rateSentSuccess.svg'

export function RateSentPageUi() {
    const router = useRouter()
    const [rating, setRating] = useState(4)
    const [uploadedImages, setUploadedImages] = useState<string[]>([])
    const [reviewText, setReviewText] = useState('Everything went great — the renter returned everything in good condition, was responsive, and treated the property with care. I recommend them!')
    ...
    return (
        <div className='text-white min-h-screen'>
            <main>
<div className='flex flex-col items-center justify-center gap-2 my-4 text-center'>

 <RateSent/>
 <h1 className='text-2xl text-white'>Review sent!</h1>
 <h3 className='text-base text-[#757575] '>Thank you for sharing your opinion!
 It is very important for us!</h3>
</div>
                <div>
