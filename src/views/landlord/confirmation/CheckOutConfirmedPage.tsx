...
export function CheckOutConfirmedPageUi() {
    ...
    const handleConfirm = () => {
        router.push('/landlord/object-details')
    }
    const navigateRateTenant = () => {
        router.push('/landlord/rate-tenant')
    }
    return (
            ...
            <main className='flex flex-col gap-4'>
                <div className='w-full h-[80vh] flex flex-col items-center justify-center gap-2'>
                    ...
                    <h3 className='text-center text-light_grey text-base'>
                        You can track the status of the object in the{' '}
                        <span>&quot;My objects&quot;</span> section
                    </h3>
                </div>
