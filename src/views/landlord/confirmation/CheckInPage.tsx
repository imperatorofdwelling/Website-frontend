...
import HotelFeatureCard from '@/src/shared/ui/landlord/confirmation/CheckIn/HotelFeatureCard/HotelFeatureCard'
import AmenitiesCard from '@/src/shared/ui/landlord/confirmation/CheckIn/AmenitiesCard/AmenitiesCard'
...
export function CheckInPageUi() {
    ...
    return (
        <div className='text-white min-h-screen'>
            <Header title='Confirm check-in' rightContent={<><button><CrossIcon/></button></>}/>
            <main className='flex flex-col gap-4'>
                ...
                <div>
                    ...
                    <div className='py-4 flex  items-start gap-3'>
                        <Image src={user} alt='user' className='h-[80px] w-[80px] rounded-lg'/>

                        <div>
                            <h3 className='text-light_grey text-sm'>Name: <span className='text-white'> Surname </span></h3>
                            <p className='text-light_grey text-sm flex items-center gap-1'>Rating: <span className='text-white flex items-center gap-1'><Star/> 4.55</span></p>
                            <p className='text-light_grey text-sm'>Phone: <span className='text-white'>+33 84947 4949</span></p>
                            <p className='text-light_grey text-sm'>E-mail: <span className='text-white'>privetmedved@gmail.com</span></p>
                        </div>
                    </div>

                    <div className='py-2 flex items-center justify-between'>
                        <div>
                            <h3 className='text-base font-medium'>Contact the tenant</h3>
                            <p className='text-light_grey text-sm'>Write to the tenant for more information</p>
                        </div>
...
<button
  ...
  onClick={() => router.push('/landlord/check-in-confirmed')}
>
  Confirm check-in
</button>
